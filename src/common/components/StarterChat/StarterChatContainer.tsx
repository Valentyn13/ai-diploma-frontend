...
const WELCOME_MESSAGE =
  'Привіт, як добре, що ти прийшов. Я збираюся задати кілька запитань, які допоможуть мені краще пізнати вас і підібрати для вас найточніший процес. Ділитися можна лише тим, що зручно – кожна дрібниця може допомогти. Почнемо?';

const ENDING_MESSAGE =
  'Дякуємо, що ви поділилися інформацією! Відтепер я можу допомагати вам краще.';
