      ...
      <WithSlideInX delay={300}>
        <WithFadeIn delay={300}>
          <AppText
            ...
            {'5 хвилин на день, ось і вся історія'}
          </AppText>
        </WithFadeIn>
      </WithSlideInX>
      <WithSlideInY delay={600}>
        <WithFadeIn delay={600}>
          <AppText
            ...
            {
              'Це так просто і легко зробити суттєві зміни в житті, лише 5 хвилин на день, і ви зможете відчути ефект покращення стану тіла та розуму.\n\n Короткий час... великий ефект!'
            }
          </AppText>
        </WithFadeIn>
      </WithSlideInY>
