...
export const removeFavoriteMeditation = createAction(
  'REMOVE_FAVORITE_MEDITATION',
);
...
export const turnOffShowReminderPopup = createAction(
  'TURN_OFF_SHOW_REMINDER_POPUP',
);
